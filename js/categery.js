...
function initLeft(){
    //找到父容器
    var parentDom = document.getElementsByClassName("jd_categery_left")[0];
    var rightDom = document.getElementsByClassName("jd_categery_right")[0];
    //找到子容器
...
function initRight(){
    //右侧
    var parentDom = document.getElementsByClassName("jd_categery_right")[0];
    //找到子容器
    var childDom = parentDom.getElementsByClassName('jd_categery_right_box')[0];
    console.log(childDom);
